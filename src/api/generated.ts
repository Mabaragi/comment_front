...
export const crawlerEpisodeRead = (productId: string, signal?: AbortSignal) => {
  return axiosInstance<Episode>({
    url: `http://localhost:8000/crawler/episode/${productId}/`,
    method: 'GET',
    signal,
  });
};
...
export const getCrawlerEpisodeReadQueryKey = (productId: string) => {
  return [`http://localhost:8000/crawler/episode/${productId}/`] as const;
};
...
export const crawlerEpisodeCommentList = (
  ...
  return axiosInstance<CrawlerEpisodeCommentList200>({
    url: `http://localhost:8000/crawler/episode/${productId}/comment`,
    method: 'GET',
    params,
    signal,
  });
...
export const getCrawlerEpisodeCommentListQueryKey = (
  ...
  return [
    `http://localhost:8000/crawler/episode/${productId}/comment`,
    ...(params ? [params] : []),
  ] as const;
};
...
export const crawlerSeriesList = (
  ...
  return axiosInstance<Series[]>({
    url: `http://localhost:8000/crawler/series/`,
    method: 'GET',
    params,
    signal,
  });
...
export const getCrawlerSeriesListQueryKey = (
  ...
  return [
    `http://localhost:8000/crawler/series/`,
    ...(params ? [params] : []),
  ] as const;
};
...
export const crawlerSeriesCrawlCreate = (
  ...
  return axiosInstance<Series>({
    url: `http://localhost:8000/crawler/series/crawl/`,
    method: 'POST',
...
export const crawlerSeriesRead = (seriesId: string, signal?: AbortSignal) => {
  return axiosInstance<Series>({
    url: `http://localhost:8000/crawler/series/${seriesId}/`,
    method: 'GET',
    signal,
  });
};
...
export const getCrawlerSeriesReadQueryKey = (seriesId: string) => {
  return [`http://localhost:8000/crawler/series/${seriesId}/`] as const;
};
...
export const crawlerSeriesEpisodeList = (
  ...
  return axiosInstance<CrawlerSeriesEpisodeList200>({
    url: `http://localhost:8000/crawler/series/${seriesId}/episode/`,
    method: 'GET',
    params,
    signal,
  });
...
export const getCrawlerSeriesEpisodeListQueryKey = (
  ...
  return [
    `http://localhost:8000/crawler/series/${seriesId}/episode/`,
    ...(params ? [params] : []),
  ] as const;
};
...
export const crawlerSeriesEpisodeCrawlCreate = (
  ...
  return axiosInstance<EpisodeCreateResponse>({
    url: `http://localhost:8000/crawler/series/${seriesId}/episode/crawl`,
    method: 'POST',
    signal,
  });
};
...
export const llmApiEmotionAnalysisRead = (
  ...
  return axiosInstance<CommentEmotionAnalysis>({
    url: `http://localhost:8000/llm/api/emotion-analysis/${commentId}/`,
    method: 'GET',
    signal,
  });
};
...
export const getLlmApiEmotionAnalysisReadQueryKey = (commentId: string) => {
  return [
    `http://localhost:8000/llm/api/emotion-analysis/${commentId}/`,
  ] as const;
};

export const getLlmApiEmotionAnalysisReadQueryOptions = <
  TData = Awaited<ReturnType<typeof llmApiEmotionAnalysisRead>>,
  TError = void,
>(
  commentId: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getLlmApiEmotionAnalysisReadQueryKey(commentId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof llmApiEmotionAnalysisRead>>
  > = ({ signal }) => llmApiEmotionAnalysisRead(commentId, signal);
...
export type LlmApiEmotionAnalysisReadQueryResult = NonNullable<
  Awaited<ReturnType<typeof llmApiEmotionAnalysisRead>>
>;
export type LlmApiEmotionAnalysisReadQueryError = void;

export function useLlmApiEmotionAnalysisRead<
  TData = Awaited<ReturnType<typeof llmApiEmotionAnalysisRead>>,
  TError = void,
>(
  commentId: string,
...
>(
  ...
  const queryOptions = getLlmApiEmotionAnalysisReadQueryOptions(
    commentId,
    options,
  );
...
export const getLlmApiEmotionAnalysisCreateMutationOptions = <
  TError = void,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type LlmApiEmotionAnalysisCreateMutationResult = NonNullable<
  Awaited<ReturnType<typeof llmApiEmotionAnalysisCreate>>
>;

export type LlmApiEmotionAnalysisCreateMutationError = void;

export const useLlmApiEmotionAnalysisCreate = <
  TError = void,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getLlmApiEmotionAnalysisCreateMutationOptions(options);
...
export const llmApiEmotionAnalysisDeleteDelete = (commentId: string) => {
  return axiosInstance<void>({
    url: `http://localhost:8000/llm/api/emotion-analysis/${commentId}/delete/`,
    method: 'DELETE',
  });
};
...
export const llmApiSummaryAnalysisCreate = (
  ...
  return axiosInstance<void>({
    url: `http://localhost:8000/llm/api/summary-analysis/${episodeId}/`,
    method: 'POST',
    signal,
  });
};
...
export const getUserListQueryKey = () => {
  return [`http://localhost:8000/user/`] as const;
};
